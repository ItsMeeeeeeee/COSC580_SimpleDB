...
#
# p.execute("CREATE TABLE Course ( ID int, COURSE String)")
...
p.execute("SELECT * FROM STUDENT JOIN STUDENT_BACKGROUND ON STUDENT.ID = STUDENT_BACKGROUND.ID WHERE ID > 1")
