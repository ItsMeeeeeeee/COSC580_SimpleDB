...
# p.execute("SELECT count(*) FROM TABLE2")
# p.execute("SELECT count(COL2), avg(COL2) FROM TABLE2")
# p.execute("SELECT avg(COL2) FROM TABLE2")
# p.execute("SELECT min(COL2) FROM TABLE2")
# p.execute("SELECT max(COL2) FROM TABLE2")
# p.execute("SELECT AVG(COL2), MIN(COL2) FROM TABLE2 WHERE COL2 > 18 GROUP BY COL3")
# p.execute("SELECT AVG(COL2) FROM TABLE2 GROUP BY COL3")
p.execute("SELECT COL1 FROM TABLE2 WHERE COL2 > 5 ORDER BY COL2 LIMIT 3")
